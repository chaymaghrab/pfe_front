...
function YearPickerComponent_table_0_tr_14_td_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function YearPickerComponent_table_0_tr_14_td_1_Template_button_click_1_listener() { ɵngcc0.ɵɵrestoreView(_r292); const dtz_r290 = ctx.$implicit; const ctx_r291 = ɵngcc0.ɵɵnextContext(3); return ctx_r291.datePicker.select(dtz_r290.date); });
    ...
    const dtz_r290 = ctx.$implicit;
    const ctx_r289 = ɵngcc0.ɵɵnextContext(3);
    ɵngcc0.ɵɵattribute("id", dtz_r290.uid);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(5, _c0, ctx_r289.isBs4 && !dtz_r290.selected && !ctx_r289.datePicker.isActive(dtz_r290), dtz_r290.selected || ctx_r289.isBs4 && !dtz_r290.selected && ctx_r289.datePicker.isActive(dtz_r290), dtz_r290.disabled, !ctx_r289.isBs4 && ctx_r289.datePicker.isActive(dtz_r290)))("disabled", dtz_r290.disabled);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(10, _c1, ctx_r289.isBs4 && dtz_r290.current, !ctx_r289.isBs4 && dtz_r290.current));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(dtz_r290.label);
} }
function YearPickerComponent_table_0_tr_14_Template(rf, ctx) { if (rf & 1) {
    ...
    const rowz_r288 = ctx.$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", rowz_r288);
} }
...
function YearPickerComponent_table_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function YearPickerComponent_table_0_Template_button_click_4_listener() { ɵngcc0.ɵɵrestoreView(_r294); const ctx_r293 = ɵngcc0.ɵɵnextContext(); return ctx_r293.datePicker.move(0 - 1); });
    ɵngcc0.ɵɵtext(5, "\u2039");
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(6, "th");
    ɵngcc0.ɵɵelementStart(7, "button", 3);
    ɵngcc0.ɵɵlistener("click", function YearPickerComponent_table_0_Template_button_click_7_listener() { ɵngcc0.ɵɵrestoreView(_r294); const ctx_r295 = ɵngcc0.ɵɵnextContext(); return ctx_r295.datePicker.toggleMode(0); });
    ...
    ɵngcc0.ɵɵlistener("click", function YearPickerComponent_table_0_Template_button_click_11_listener() { ɵngcc0.ɵɵrestoreView(_r294); const ctx_r296 = ɵngcc0.ɵɵnextContext(); return ctx_r296.datePicker.move(1); });
    ɵngcc0.ɵɵtext(12, "\u203A");
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
    ...
    ɵngcc0.ɵɵadvance(6);
    ɵngcc0.ɵɵattribute("colspan", ctx_r286.datePicker.yearColLimit - 2 <= 0 ? 1 : ctx_r286.datePicker.yearColLimit - 2);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("id", ctx_r286.datePicker.uniqueId + "-title")("disabled", ctx_r286.datePicker.datepickerMode === ctx_r286.datePicker.maxMode)("ngClass", ɵngcc0.ɵɵpureFunction1(6, _c2, ctx_r286.datePicker.datepickerMode === ctx_r286.datePicker.maxMode));
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r286.title);
    ɵngcc0.ɵɵadvance(5);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r286.rows);
} }
