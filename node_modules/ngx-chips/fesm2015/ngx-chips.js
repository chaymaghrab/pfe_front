...
function TagComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r210.editing);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(3, _c1, ctx_r210.model, ctx_r210.index))("ngTemplateOutlet", ctx_r210.template);
} }
function TagComponent_div_2_delete_icon_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function TagComponent_div_2_delete_icon_3_Template_delete_icon_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r216); const ctx_r215 = ɵngcc0.ɵɵnextContext(2); return ctx_r215.remove($event); });
    ɵngcc0.ɵɵelementEnd();
} }
function TagComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown.enter", function TagComponent_div_2_Template_div_keydown_enter_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r218); const ctx_r217 = ɵngcc0.ɵɵnextContext(); return ctx_r217.disableEditMode($event); })("keydown.escape", function TagComponent_div_2_Template_div_keydown_escape_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r218); const ctx_r219 = ɵngcc0.ɵɵnextContext(); return ctx_r219.disableEditMode($event); })("click", function TagComponent_div_2_Template_div_click_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r218); const ctx_r220 = ɵngcc0.ɵɵnextContext(); return ctx_r220.editing ? $event.stopPropagation() : undefined; })("blur", function TagComponent_div_2_Template_div_blur_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r218); const ctx_r221 = ɵngcc0.ɵɵnextContext(); return ctx_r221.onBlurred($event); });
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵelementEnd();
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r211.editing)("title", ctx_r211.getDisplayValue(ctx_r211.model));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r211.getDisplayValue(ctx_r211.model), " ");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r211.isDeleteIconVisible());
} }
function TagComponent_tag_ripple_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("state", ctx_r212.rippleState);
...
function TagInputDropdown_ng2_menu_item_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r223 = ɵngcc0.ɵɵnextContext().$implicit;
    const ctx_r226 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("innerHTML", ɵngcc0.ɵɵpipeBind2(1, 1, item_r223[ctx_r226.displayBy], ctx_r226.tagInput.inputForm.value.value), ɵngcc0.ɵɵsanitizeHtml);
} }
...
function TagInputDropdown_ng2_menu_item_2_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r223 = ctx_r230.$implicit;
    const index_r224 = ctx_r230.index;
    const last_r225 = ctx_r230.last;
    const ctx_r227 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r227.templates.first)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction3(2, _c2, item_r223, index_r224, last_r225));
} }
function TagInputDropdown_ng2_menu_item_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("value", item_r223)("ngSwitch", !!ctx_r222.templates.length);
    ɵngcc0.ɵɵadvance(1);
...
function TagInputComponent_tag_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onSelect", function TagInputComponent_tag_2_Template_tag_onSelect_0_listener() { ɵngcc0.ɵɵrestoreView(_r237); const item_r234 = ctx.$implicit; const ctx_r236 = ɵngcc0.ɵɵnextContext(); return ctx_r236.selectItem(item_r234); })("onRemove", function TagInputComponent_tag_2_Template_tag_onRemove_0_listener() { ɵngcc0.ɵɵrestoreView(_r237); const item_r234 = ctx.$implicit; const i_r235 = ctx.index; const ctx_r238 = ɵngcc0.ɵɵnextContext(); return ctx_r238.onRemoveRequested(item_r234, i_r235); })("onKeyDown", function TagInputComponent_tag_2_Template_tag_onKeyDown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r237); const ctx_r239 = ɵngcc0.ɵɵnextContext(); return ctx_r239.handleKeydown($event); })("onTagEdited", function TagInputComponent_tag_2_Template_tag_onTagEdited_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r237); const ctx_r240 = ɵngcc0.ɵɵnextContext(); return ctx_r240.updateEditedTag($event); })("onBlur", function TagInputComponent_tag_2_Template_tag_onBlur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r237); const i_r235 = ctx.index; const ctx_r241 = ɵngcc0.ɵɵnextContext(); return ctx_r241.onTagBlurred($event, i_r235); })("dragstart", function TagInputComponent_tag_2_Template_tag_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r237); const item_r234 = ctx.$implicit; const i_r235 = ctx.index; const ctx_r242 = ɵngcc0.ɵɵnextContext(); return ctx_r242.dragZone ? ctx_r242.onDragStarted($event, item_r234, i_r235) : undefined; })("drop", function TagInputComponent_tag_2_Template_tag_drop_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r237); const i_r235 = ctx.index; const ctx_r243 = ɵngcc0.ɵɵnextContext(); return ctx_r243.dragZone ? ctx_r243.onTagDropped($event, i_r235) : undefined; })("dragenter", function TagInputComponent_tag_2_Template_tag_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r237); const ctx_r244 = ɵngcc0.ɵɵnextContext(); return ctx_r244.dragZone ? ctx_r244.onDragOver($event) : undefined; })("dragover", function TagInputComponent_tag_2_Template_tag_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r237); const i_r235 = ctx.index; const ctx_r245 = ɵngcc0.ɵɵnextContext(); return ctx_r245.dragZone ? ctx_r245.onDragOver($event, i_r235) : undefined; })("dragleave", function TagInputComponent_tag_2_Template_tag_dragleave_0_listener() { ɵngcc0.ɵɵrestoreView(_r237); const ctx_r246 = ɵngcc0.ɵɵnextContext(); return ctx_r246.dragZone ? ctx_r246.dragProvider.onDragEnd() : undefined; });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const item_r234 = ctx.$implicit;
    const i_r235 = ctx.index;
    const ctx_r231 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵpropertyInterpolate("draggable", ctx_r231.editable);
    ɵngcc0.ɵɵproperty("canAddTag", ctx_r231.isTagValid)("disabled", ctx_r231.disable)("@animation", ctx_r231.animationMetadata)("hasRipple", ctx_r231.ripple)("index", i_r235)("removable", ctx_r231.removable)("editable", ctx_r231.editable)("displayBy", ctx_r231.displayBy)("identifyBy", ctx_r231.identifyBy)("template", !!ctx_r231.hasCustomTemplate() ? ctx_r231.templates.first : undefined)("draggable", ctx_r231.dragZone)("model", item_r234);
...
function TagInputComponent_div_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r233.theme);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r233.errors);
} }
const _c3 = ["*"];
